...
ROLES = {
    ...
    "2": {
        "name": "生成 AI 製品エキスパート",
        "description": "生成 AI や関連製品、技術に関する専門的な質問に答える",
        "details": "生成 AI や関連製品、技術に関する専門的な質問に対して、最新の情報と深い洞察を提供してください。",
    },
    "3": {
        "name": "カウンセラー",
...
# Initialize the LLM with configurable max_tokens
...
if __name__ == "__main__":
    ...
    initial_state = State(query="生成 AI について教えてください")
